...
export default function useCards(initialComp){
    ...
    function compare(prop){
        ...
        playerNew = update(player, { $splice: [[0, 1]] })
        //playerNew = player.splice(0,1);
        computerNew = update(computer, { $splice: [[0, 1]] })
        //computerNew = computer.splice(0,1);
